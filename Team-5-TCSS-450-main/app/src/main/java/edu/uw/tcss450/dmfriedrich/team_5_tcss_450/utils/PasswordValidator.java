package edu.uw.tcss450.dmfriedrich.team_5_tcss_450.utils;
...
public interface PasswordValidator
    ...
    /**
     * Returns a validator that when applied will validate that the String does match format
     *
     * @return avalidator that validates that the String have format of array address
     */
    static PasswordValidator checkEmailAvailble() {
        return password ->
                Optional.of(password.matches(".*[@].*[.].*") ?
