package edu.uw.tcss450.dmfriedrich.team_5_tcss_450.services;
...
import edu.uw.tcss450.dmfriedrich.team_5_tcss_450.AuthActivity;
...
import edu.uw.tcss450.dmfriedrich.team_5_tcss_450.ui.chat.ChatMessage;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    if (typeOfMessage.equals("msg")) {
        ...
        if (appProcessInfo.importance == IMPORTANCE_FOREGROUND || appProcessInfo.importance == IMPORTANCE_VISIBLE) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                    .setAutoCancel(true)
                    .setSmallIcon(R.drawable.bottom_message_icon)
    ...
    if (typeOfMessage.equals("cnt")) {
        AccountProfile contact = null;
        String email = "";
        String nickname = "";
        int status = -1;
        try {
            contact = AccountProfile.createFromJsonString(intent.getStringExtra("contact"));
        ...
        if (appProcessInfo.importance == IMPORTANCE_FOREGROUND || appProcessInfo.importance == IMPORTANCE_VISIBLE) {
            //app is in the foreground so send the message to the active Activities
            Log.d("PUSHY", "Message received in foreground: " + email);
            ...
            //app is in the background so create and post a notification
            Log.d("PUSHY", "Message received in background: " + contact.getEmail());
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                    .setAutoCancel(true)
                    .setSmallIcon(R.drawable.my_account_icon)
                    .setContentTitle("Contact request from: " + contact.getNickname())
